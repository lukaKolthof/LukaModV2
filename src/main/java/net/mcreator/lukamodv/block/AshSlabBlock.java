...
public class AshSlabBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ash_slab")
	public static final Block block = null;
	public AshSlabBlock(LukamodV2ModElements instance) {
		super(instance, 190);
	}
