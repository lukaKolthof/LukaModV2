...
public class RubyPlantBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ruby_plant")
	public static final Block block = null;
	public RubyPlantBlock(LukamodV2ModElements instance) {
		super(instance, 102);
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new DefaultFlowersFeature(BlockClusterFeatureConfig.field_236587_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
					...
					if (dimensionType == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("lukamod_v2:ruby_dimension")))
			...
			event.getRegistry().register(feature.setRegistryName("ruby_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lukamod_v2:ruby_plant"), configuredFeature);
		}
	}
	@SubscribeEvent
