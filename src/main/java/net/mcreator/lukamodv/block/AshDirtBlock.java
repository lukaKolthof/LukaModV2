...
public class AshDirtBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ash_dirt")
	public static final Block block = null;
	public AshDirtBlock(LukamodV2ModElements instance) {
		super(instance, 217);
	}
