...
public class RubyWoodFenceBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ruby_wood_fence")
	public static final Block block = null;
	public RubyWoodFenceBlock(LukamodV2ModElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("ruby_wood_fence");
		}
