...
public class SilverBlockBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:silver_block")
	public static final Block block = null;
	public SilverBlockBlock(LukamodV2ModElements instance) {
		super(instance, 66);
	}
