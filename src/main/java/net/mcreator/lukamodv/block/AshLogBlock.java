...
public class AshLogBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ash_log")
	public static final Block block = null;
	public AshLogBlock(LukamodV2ModElements instance) {
		super(instance, 186);
	}
