...
import net.mcreator.lukamodv.item.CopperIngotItem;
...
public class CopperOreBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(LukamodV2ModElements instance) {
		super(instance, 252);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("lukamod_v2:copper_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lukamod_v2:copper_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
