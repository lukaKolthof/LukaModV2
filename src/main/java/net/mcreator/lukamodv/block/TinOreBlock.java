...
import net.mcreator.lukamodv.item.TinIngotItem;
...
public class TinOreBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:tin_ore")
	public static final Block block = null;
	public TinOreBlock(LukamodV2ModElements instance) {
		super(instance, 228);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TinIngotItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("lukamod_v2:tin_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lukamod_v2:tin_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
