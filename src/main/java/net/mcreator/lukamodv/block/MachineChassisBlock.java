...
public class MachineChassisBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:machine_chassis")
	public static final Block block = null;
	public MachineChassisBlock(LukamodV2ModElements instance) {
		super(instance, 135);
	}
