...
public class RubyWoodWoodBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ruby_wood_wood")
	public static final Block block = null;
	public RubyWoodWoodBlock(LukamodV2ModElements instance) {
		super(instance, 86);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ruby_wood_wood");
		}
