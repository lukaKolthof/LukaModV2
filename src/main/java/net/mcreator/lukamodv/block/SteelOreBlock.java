...
import net.mcreator.lukamodv.item.SteelIngotItem;
...
public class SteelOreBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:steel_ore")
	public static final Block block = null;
	public SteelOreBlock(LukamodV2ModElements instance) {
		super(instance, 158);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SteelIngotItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("lukamod_v2:steel_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lukamod_v2:steel_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
