...
public class AshWoodBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ash_wood")
	public static final Block block = null;
	public AshWoodBlock(LukamodV2ModElements instance) {
		super(instance, 185);
	}
