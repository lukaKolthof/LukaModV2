...
public class BrassBlockBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:brass_block")
	public static final Block block = null;
	public BrassBlockBlock(LukamodV2ModElements instance) {
		super(instance, 298);
	}
