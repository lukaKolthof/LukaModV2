...
public class CopperBlockBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:copper_block")
	public static final Block block = null;
	public CopperBlockBlock(LukamodV2ModElements instance) {
		super(instance, 253);
	}
