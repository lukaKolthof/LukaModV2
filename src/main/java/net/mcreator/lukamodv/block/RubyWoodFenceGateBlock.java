...
public class RubyWoodFenceGateBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ruby_wood_fence_gate")
	public static final Block block = null;
	public RubyWoodFenceGateBlock(LukamodV2ModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("ruby_wood_fence_gate");
		}
