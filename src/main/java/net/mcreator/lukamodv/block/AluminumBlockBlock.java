...
public class AluminumBlockBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:aluminum_block")
	public static final Block block = null;
	public AluminumBlockBlock(LukamodV2ModElements instance) {
		super(instance, 320);
	}
