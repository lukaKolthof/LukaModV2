...
public class AshPlanksBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ash_planks")
	public static final Block block = null;
	public AshPlanksBlock(LukamodV2ModElements instance) {
		super(instance, 187);
	}
