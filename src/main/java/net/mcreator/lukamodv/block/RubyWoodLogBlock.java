...
public class RubyWoodLogBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ruby_wood_log")
	public static final Block block = null;
	public RubyWoodLogBlock(LukamodV2ModElements instance) {
		super(instance, 87);
	}
