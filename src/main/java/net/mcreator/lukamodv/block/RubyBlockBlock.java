...
public class RubyBlockBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ruby_block")
	public static final Block block = null;
	public RubyBlockBlock(LukamodV2ModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(1.5f, 10f).setLightLevel(s -> 0).harvestLevel(2)
