...
import net.mcreator.lukamodv.procedures.SolarPanelUpdateTickProcedure;
...
public class SolarPanelBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:solar_panel")
	public static final Block block = null;
	public SolarPanelBlock(LukamodV2ModElements instance) {
		super(instance, 131);
	}
