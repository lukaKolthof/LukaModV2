...
public class SteelBlockBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:steel_block")
	public static final Block block = null;
	public SteelBlockBlock(LukamodV2ModElements instance) {
		super(instance, 159);
	}
