...
public class RubyWoodStairsBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ruby_wood_stairs")
	public static final Block block = null;
	public RubyWoodStairsBlock(LukamodV2ModElements instance) {
		super(instance, 90);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ruby_wood_stairs");
		}
