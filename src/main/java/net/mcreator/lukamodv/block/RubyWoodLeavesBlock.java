...
public class RubyWoodLeavesBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ruby_wood_leaves")
	public static final Block block = null;
	public RubyWoodLeavesBlock(LukamodV2ModElements instance) {
		super(instance, 89);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("ruby_wood_leaves");
		}
