...
public class AluminiumBlockBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:aluminium_block")
	public static final Block block = null;
	public AluminiumBlockBlock(LukamodV2ModElements instance) {
		super(instance, 275);
	}
