...
public class AshFenceBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ash_fence")
	public static final Block block = null;
	public AshFenceBlock(LukamodV2ModElements instance) {
		super(instance, 191);
	}
