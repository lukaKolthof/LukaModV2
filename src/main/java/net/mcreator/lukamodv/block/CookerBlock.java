...
import net.mcreator.lukamodv.procedures.CookerBlockIsPlacedByProcedure;
...
public class CookerBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:cooker")
	public static final Block block = null;
	public CookerBlock(LukamodV2ModElements instance) {
		super(instance, 224);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState blockstate, LivingEntity entity, ItemStack itemstack) {
			...
			int z = pos.getZ();
			{
				...
				CookerBlockIsPlacedByProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
