...
public class AshStairsBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ash_stairs")
	public static final Block block = null;
	public AshStairsBlock(LukamodV2ModElements instance) {
		super(instance, 189);
	}
