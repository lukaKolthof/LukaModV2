...
public class RubyWoodPlanksBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ruby_wood_planks")
	public static final Block block = null;
	public RubyWoodPlanksBlock(LukamodV2ModElements instance) {
		super(instance, 88);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ruby_wood_planks");
		}
