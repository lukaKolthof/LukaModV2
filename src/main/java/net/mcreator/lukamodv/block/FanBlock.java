...
import net.mcreator.lukamodv.procedures.FanUpdateTickProcedure;
...
public class FanBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:fan")
	public static final Block block = null;
	@ObjectHolder("lukamod_v2:fan")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public FanBlock(LukamodV2ModElements instance) {
		super(instance, 132);
