...
public class TableBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:table")
	public static final Block block = null;
	public TableBlock(LukamodV2ModElements instance) {
		super(instance, 129);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(0, 0, 14, 2, 14, 16), makeCuboidShape(0, 14, 0, 16, 15, 16), makeCuboidShape(14, 0, 14, 16, 14, 16),
					makeCuboidShape(14, 0, 0, 16, 14, 2), makeCuboidShape(0, 0, 0, 2, 14, 2)).withOffset(offset.x, offset.y, offset.z);
		}
