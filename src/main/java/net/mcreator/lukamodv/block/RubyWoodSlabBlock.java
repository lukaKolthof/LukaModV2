...
public class RubyWoodSlabBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ruby_wood_slab")
	public static final Block block = null;
	public RubyWoodSlabBlock(LukamodV2ModElements instance) {
		super(instance, 91);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("ruby_wood_slab");
		}
