...
import net.mcreator.lukamodv.procedures.BatteryUpdateTickProcedure;
...
public class BatteryBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:battery")
	public static final Block block = null;
	@ObjectHolder("lukamod_v2:battery")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public BatteryBlock(LukamodV2ModElements instance) {
		super(instance, 134);
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		private final EnergyStorage energyStorage = new EnergyStorage(2100000091, 2000000000, 2111111111, 0) {
			@Override
