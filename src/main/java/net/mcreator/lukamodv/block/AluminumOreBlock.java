...
import net.mcreator.lukamodv.item.AluminumIngotItem;
...
public class AluminumOreBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:aluminum_ore")
	public static final Block block = null;
	public AluminumOreBlock(LukamodV2ModElements instance) {
		super(instance, 319);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("lukamod_v2:aluminum_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lukamod_v2:aluminum_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
