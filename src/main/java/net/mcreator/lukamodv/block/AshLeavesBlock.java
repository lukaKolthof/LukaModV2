...
import net.mcreator.lukamodv.procedures.AshLeavesBlockDestroyedByPlayerProcedure;
...
public class AshLeavesBlock extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ash_leaves")
	public static final Block block = null;
	public AshLeavesBlock(LukamodV2ModElements instance) {
		super(instance, 188);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				AshLeavesBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
