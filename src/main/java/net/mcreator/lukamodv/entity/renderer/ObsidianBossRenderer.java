package net.mcreator.lukamodv.entity.renderer;
...
@OnlyIn(Dist.CLIENT)
public class ObsidianBossRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ObsidianBossEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelsteve(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("lukamod_v2:textures/a437503d3bbfa097.png");
					}
				};
			});
		}
