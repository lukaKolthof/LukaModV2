...
import net.mcreator.lukamodv.procedures.Page2Procedure;
...
public class LightChestGuiGui extends LukamodV2ModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public LightChestGuiGui(LukamodV2ModElements instance) {
		super(instance, 340);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("light_chest_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, LightChestGuiGuiWindow::new));
	}
		...
		if (buttonID == 0) {
			{
				...
				Page2Procedure.executeProcedure($_dependencies);
			}
		}
	}
