...
public class TinPickaxeItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:tin_pickaxe")
	public static final Item block = null;
	public TinPickaxeItem(LukamodV2ModElements instance) {
		super(instance, 233);
	}
