...
public class QAshSwordItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:q_ash_sword")
	public static final Item block = null;
	public QAshSwordItem(LukamodV2ModElements instance) {
		super(instance, 209);
	}
