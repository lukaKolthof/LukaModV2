...
public class SilverSwordItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:silver_sword")
	public static final Item block = null;
	public SilverSwordItem(LukamodV2ModElements instance) {
		super(instance, 72);
	}
