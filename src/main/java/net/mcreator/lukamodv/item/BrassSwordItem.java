...
public class BrassSwordItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:brass_sword")
	public static final Item block = null;
	public BrassSwordItem(LukamodV2ModElements instance) {
		super(instance, 304);
	}
