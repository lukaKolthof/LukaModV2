...
public class BrassHoeItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:brass_hoe")
	public static final Item block = null;
	public BrassHoeItem(LukamodV2ModElements instance) {
		super(instance, 306);
	}
