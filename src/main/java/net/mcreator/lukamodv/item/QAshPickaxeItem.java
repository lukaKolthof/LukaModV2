...
public class QAshPickaxeItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:q_ash_pickaxe")
	public static final Item block = null;
	public QAshPickaxeItem(LukamodV2ModElements instance) {
		super(instance, 207);
	}
