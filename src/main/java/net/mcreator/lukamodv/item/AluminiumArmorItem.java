...
public class AluminiumArmorItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:aluminium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("lukamod_v2:aluminium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("lukamod_v2:aluminium_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("lukamod_v2:aluminium_armor_boots")
	public static final Item boots = null;
	public AluminiumArmorItem(LukamodV2ModElements instance) {
		super(instance, 289);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "lukamod_v2:textures/models/armor/aluminium_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
