...
public class QuartzSwordItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:quartz_sword")
	public static final Item block = null;
	public QuartzSwordItem(LukamodV2ModElements instance) {
		super(instance, 55);
	}
