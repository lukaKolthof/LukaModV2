...
public class SteelSwordItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:steel_sword")
	public static final Item block = null;
	public SteelSwordItem(LukamodV2ModElements instance) {
		super(instance, 165);
	}
