...
public class AluminiumPickaxeItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:aluminium_pickaxe")
	public static final Item block = null;
	public AluminiumPickaxeItem(LukamodV2ModElements instance) {
		super(instance, 279);
	}
