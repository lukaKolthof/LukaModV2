...
public class AluminumPickaxeItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:aluminum_pickaxe")
	public static final Item block = null;
	public AluminumPickaxeItem(LukamodV2ModElements instance) {
		super(instance, 324);
	}
