...
public class SteelPickaxeItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:steel_pickaxe")
	public static final Item block = null;
	public SteelPickaxeItem(LukamodV2ModElements instance) {
		super(instance, 163);
	}
