...
public class SilverHoeItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:silver_hoe")
	public static final Item block = null;
	public SilverHoeItem(LukamodV2ModElements instance) {
		super(instance, 74);
	}
