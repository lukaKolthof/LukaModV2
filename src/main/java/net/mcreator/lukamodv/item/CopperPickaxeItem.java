...
public class CopperPickaxeItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:copper_pickaxe")
	public static final Item block = null;
	public CopperPickaxeItem(LukamodV2ModElements instance) {
		super(instance, 257);
	}
