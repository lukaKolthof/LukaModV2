...
public class AluminumHoeItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:aluminum_hoe")
	public static final Item block = null;
	public AluminumHoeItem(LukamodV2ModElements instance) {
		super(instance, 328);
	}
