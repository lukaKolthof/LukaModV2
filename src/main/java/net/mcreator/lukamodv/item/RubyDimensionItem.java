...
import net.mcreator.lukamodv.world.dimension.RubyDimensionDimension;
import net.mcreator.lukamodv.itemgroup.LukaModv2ItemGroup;

public class RubyDimensionItem extends Item {
	@ObjectHolder("lukamod_v2:ruby_dimension")
	public static final Item block = null;
	public RubyDimensionItem() {
		super(new Item.Properties().group(LukaModv2ItemGroup.tab).maxDamage(64));
	}
