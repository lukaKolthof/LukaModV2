...
public class IronStickItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:iron_stick")
	public static final Item block = null;
	public IronStickItem(LukamodV2ModElements instance) {
		super(instance, 114);
	}
