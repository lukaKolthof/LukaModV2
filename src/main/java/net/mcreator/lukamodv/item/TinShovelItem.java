...
public class TinShovelItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:tin_shovel")
	public static final Item block = null;
	public TinShovelItem(LukamodV2ModElements instance) {
		super(instance, 236);
	}
