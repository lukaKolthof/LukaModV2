...
public class CopperAxeItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:copper_axe")
	public static final Item block = null;
	public CopperAxeItem(LukamodV2ModElements instance) {
		super(instance, 258);
	}
