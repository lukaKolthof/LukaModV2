...
public class QAshShovelItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:q_ash_shovel")
	public static final Item block = null;
	public QAshShovelItem(LukamodV2ModElements instance) {
		super(instance, 210);
	}
