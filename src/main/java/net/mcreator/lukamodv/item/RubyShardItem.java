...
public class RubyShardItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:ruby_shard")
	public static final Item block = null;
	public RubyShardItem(LukamodV2ModElements instance) {
		super(instance, 11);
	}
