...
public class AluminiumShovelItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:aluminium_shovel")
	public static final Item block = null;
	public AluminiumShovelItem(LukamodV2ModElements instance) {
		super(instance, 282);
	}
