...
public class SolarCellItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:solar_cell")
	public static final Item block = null;
	public SolarCellItem(LukamodV2ModElements instance) {
		super(instance, 136);
	}
