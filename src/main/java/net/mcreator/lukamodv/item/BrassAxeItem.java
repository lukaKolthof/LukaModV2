...
public class BrassAxeItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:brass_axe")
	public static final Item block = null;
	public BrassAxeItem(LukamodV2ModElements instance) {
		super(instance, 303);
	}
