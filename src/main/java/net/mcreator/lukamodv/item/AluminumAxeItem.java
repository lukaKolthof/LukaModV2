...
public class AluminumAxeItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:aluminum_axe")
	public static final Item block = null;
	public AluminumAxeItem(LukamodV2ModElements instance) {
		super(instance, 325);
	}
