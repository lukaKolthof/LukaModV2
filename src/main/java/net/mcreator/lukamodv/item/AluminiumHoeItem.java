...
public class AluminiumHoeItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:aluminium_hoe")
	public static final Item block = null;
	public AluminiumHoeItem(LukamodV2ModElements instance) {
		super(instance, 283);
	}
