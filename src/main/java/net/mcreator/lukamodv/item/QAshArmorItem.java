...
public class QAshArmorItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:q_ash_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("lukamod_v2:q_ash_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("lukamod_v2:q_ash_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("lukamod_v2:q_ash_armor_boots")
	public static final Item boots = null;
	public QAshArmorItem(LukamodV2ModElements instance) {
		super(instance, 202);
	}
