...
public class AluminumSwordItem extends LukamodV2ModElements.ModElement {
	@ObjectHolder("lukamod_v2:aluminum_sword")
	public static final Item block = null;
	public AluminumSwordItem(LukamodV2ModElements instance) {
		super(instance, 326);
	}
